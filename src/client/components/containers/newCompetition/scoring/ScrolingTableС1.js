...
class ScrolingTableC1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <div>
        {tableData.map((item, index) => {
          if (item.version === 'Группа С (сложности и их соединение)' && item.group === 'Элементы') {
            return (
...
export default connect(mapStateToProps, { editAgeInfo })(ScrolingTableC1);
